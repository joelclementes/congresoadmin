        ...
        <div class="col col-sm-12 col-md-6 mb-2">
            <div class="card p-3">
                <div class="form__container ">
                    <div for="" class="form__title">Datos del procedimiento administrativo</div>
                    ...
                    <div class="form__item">
                        ...
                        <input type="text" name="ctrl_numero" id="ctrl_numero" class="form-control form__item__input" required>
                    </div>

                    <div class="form__item col-4">
                        <label for="ctrl_fecha" class="form-label form__item__title">Fecha</label>
                        <input type="date" id="ctrl_fecha" name="ctrl_fecha" class="form-control form__item_input" required>
                    </div>
                    ...
                    <div class="form__item">
                        ...
                        <textarea type="text" name="ctrl_descripcion" id="ctrl_descripcion" class="form-control form__item__input" required/></textarea>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
<script>urlProceso = "{{ route('procedimientos.store') }}"</script>
